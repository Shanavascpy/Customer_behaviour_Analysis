...
select item_purchased,round(avg(review_rating),2) as rev_rate from customer
group by item_purchased 
order by rev_rate desc limit 5;
...
select count(customer_id) as Total_Customer,
 subscription_status, avg(purchase_amount) as Avgpurchase,
 sum(purchase_amount) as Total_purchase from customer
group by subscription_status
order by Total_purchase,Avgpurchase desc;
